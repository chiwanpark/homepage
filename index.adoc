...
[.biography]
== Biography
I'm an Applied Machine Learning Engineer at the AI Alignment Unit of link:http://www.kakaocorp.com[Kakao Corporation], where I'm building machine learning applications for various mobile and web services of Kakao.
