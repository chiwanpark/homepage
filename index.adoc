...
[.biography]
== Biography
I am a machine learning engineer at link:https://navercloudcorp.com[NAVER Cloud] Hyperscale AI team, working on large language models with its applications to agentic systems.
...
I was involved in building https://mate.kakao.com[AI Mate], a conversational agent designed to deliver personalized recommendations and assistance across various Kakao services. My contributions focus on developing a production-grade Korean conversational agent, where my key contributions include:
