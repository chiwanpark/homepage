...
[.biography]
== Biography
I am a machine learning engineer in the Hyperscale AI Model Team at link:https://navercloudcorp.com[NAVER Cloud], working on large language models for enhancing various capabilities such as instruction following, agentic behavior, reasoning, and safety alignment.
...
I also contribute to open-source machine learning libraries and data processing frameworks including link:https://github.com/axolotl-ai-cloud/axolotl/[Axolotl], link:https://github.com/linkedin/Liger-Kernel/[Liger Kernel], and link:https://flink.apache.org/[Apache Flink].
My personal projects are available on link:https://github.com/chiwanpark[my GitHub Profile].

== News
* **Jan. 27, 2026** - A paper, "OrchestrationBench: LLM-Driven Agentic Planning and Tool Use in Multi-Domain Scenarios" was accepted to link:https://iclr.cc/Conferences/2026[ICLR 2026].
* **Dec. 22, 2025** - I joined NAVER Cloud as a Machine Learning Engineer.
* **Oct. 18, 2025** - A blog post about Tensor-wise LLM Quantization with TensorRT-LLM was posted to the link:https://developer.nvidia.com/ko-kr/blog/nvidia-quantization-technology-and-tensorrt-llmbased-service-optimization/[NVIDIA Technical Blog (in Korean)].
...
Aelim Ahn, Sooyeon Lee, Hyosun Wang, *Chiwan Park*, Daeryong Kim, Jihyeon Roh, Kichang Yang, Wonjun Jang, Hwang Woosung, Min Seok Kim, and Jihoon Kang
link:https://iclr.cc/Conferences/2026[ICLR 2026] [link:https://openreview.net/forum?id=Oljnxmf4pc[paper] | link:https://github.com/kakao/OrchestrationBench[github]]
...
[.experience]
== Experience
+++NAVER Cloud Hyperscale AI Model Team (Dec. 2025 - Present)+++::
To be updated soon.

+++Kakao AI Alignment Unit (Apr. 2024 - Dec. 2025)+++::
I was involved in building https://mate.kakao.com[AI Mate], a conversational agent designed to deliver personalized recommendations and assistance across various Kakao services. My work focused on developing a production-grade Korean conversational agent, where my key contributions included:
...
+++Kakao Advanced Recommendation Technology (ART) Team (May. 2021 - Mar. 2024)<br/>Kakao R&D Center (Apr. 2018 - May. 2021)+++::
...
4. Creating a context-aware recommender system for link:https://gift.kakao.com[KakaoTalk Gift], an e-commerce feature within the KakaoTalk Messenger app. The system considered multiple contexts such as demographics, product popularity, and user history (including clicked and purchased items), by integrating text and image embeddings alongside collaborative filtering techniques.
